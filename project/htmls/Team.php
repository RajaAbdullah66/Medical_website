            ...
            <div class="row top-padding">
                <div class="col centred ">
                    <div class="round size-of-external-div">
                        <img class="team-members-image-size round  hover-color size-on-hover rgba-blue-strong"  src="../resources/Attiq.jpg"/>
                ...
                <div class="col order centred">
                    <div class="round size-of-external-div">
                        <img class="team-members-image-size round  hover-color size-on-hover rgba-blue-strong"  src="../resources/Abdullah.jpg"/>
                        <div class="positioner">
                ...
                <div class="col order-1 centred ">
                    <div class="round size-of-external-div">
                        <img class="team-members-image-size round  hover-color size-on-hover rgba-blue-strong"  src="../resources/qazi.jpg"/>
                        <div class="positioner">
                            <i class="fab fa-facebook-f"></i>
                            <i class="fab fa-linkedin-in"></i>
                            <i class="fab fa-google"></i>
